...
class ItemTest {
    ...
    private static class DummyItem extends Item {
        public DummyItem(String itemName, int createdBy, String description, double startingPrice, LocalDateTime startTime, LocalDateTime endTime) {
            super(itemName, createdBy, description, startingPrice, startTime, endTime);
        }

        public DummyItem(int id, String itemName, int createdBy, String description, double startingPrice, LocalDateTime startTime, LocalDateTime endTime) {
    ...
    void setUp() {
        ...
        item = new DummyItem("Vintage Clock", 101, "A beautiful vintage clock", 150.0, startTime, endTime);
    }
    ...
    void testConstructorWithId() {
        Item itemWithId = new DummyItem(99, "Antique Vase", 102, "Ming dynasty vase", 5000.0, startTime, endTime);
    ...
    void testGetCategory() {
        ...
        assertEquals("DummyCategory", item.getCategory(), "Should return the category defined in the dummy class");
    }
    ...
    void testPrintInfo() {
        ...
        assertDoesNotThrow(() -> item.printInfo(), "printInfo should execute without throwing exceptions");
    }
}