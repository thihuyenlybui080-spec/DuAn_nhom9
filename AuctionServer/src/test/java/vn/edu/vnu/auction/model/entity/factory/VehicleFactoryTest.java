...
class VehicleFactoryTest {
  ...
  void testCreateItem() {
    ...
    assertTrue(createdItem instanceof Vehicle,
        "The created item must be an instance of the Vehicle class");
    ...
    assertEquals("Vehicle", createdItem.getCategory(),
        "The category of the created item must be 'Vehicle'");
  }
}