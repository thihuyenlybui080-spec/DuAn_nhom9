...
class ResponseTest {
    ...
    void testSetRequestId() {
        ...
        assertEquals("new-req-id", response.getRequestId(), "The setter must correctly update the requestId");
    }
    ...
    void testToString() {
        ...
        assertEquals(expectedString, response.toString(), "The toString() output must match the expected format string");
    }
}