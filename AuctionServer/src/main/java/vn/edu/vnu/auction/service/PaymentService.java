...
public class PaymentService {
    ...
    public String createPaymentLink(Bidder bidder, int auctionId) {
        ...
        try {
            ...
            SessionCreateParams params = buildSessionCreateParams(bidder, auctionId, result, amountInCents);
    ...
    public void schedulePaymentDeadline(int auctionId) {
        if(historyManager.getResult(auctionId) == null) return;
    ...
    private SessionCreateParams buildSessionCreateParams(Bidder bidder, int auctionId, AuctionResult result, long amountInCents) {
