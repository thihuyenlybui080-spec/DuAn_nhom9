...
public class AuctionServer {
  ...
  /**
   * Khởi động server chạy vòng lặp vô hạn cho đến khi gọi stop()
   */
  public void start() {
    try {
  ...
  /**
   * Dừng server gọi khi muốn tắt server
   */
  private void stop() {
    running = false;
    try {
   ...
   * <p>
   * Khởi tạo server, thiết lập shutdown hook để kết thúc một cách an toàn, và bắt đầu lắng nghe kết
   * nối từ client.
   * </p>
   *
