 ...
 * <p>
 * Đại diện cho một sản phẩm có thể đấu giá, bao gồm tên, mô tả, giá khởi điểm, và khoảng thời gian
 * đấu giá. Các lớp con định nghĩa các danh mục sản phẩm cụ thể.
 * </p>
 */
public abstract class Item extends Entity {
   ...
   */
  public Item(String itemName, int createdBy, String description, double startingPrice,
   ...
   * @param endTime       thời gian kết thúc đấu giá
   */
  public Item(int id, String itemName, int createdBy, String description, double startingPrice,
      LocalDateTime startTime, LocalDateTime endTime) {
    super(id);
    this.createdBy = createdBy;
    this.itemName = itemName;
