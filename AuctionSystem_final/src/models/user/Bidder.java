...
import models.manager.AuctionHistoryManager;
...
public class Bidder extends User  {
    ...
    public boolean payForAuction(String auctionId) {
        ...
        if (result.getStatus() != AuctionStatus.FINISHED) {
            System.err.println("❌ Chỉ có thể thanh toán khi phiên đã FINISHED.");
            return false;
        }
        ...
        ahm.updateStatusPaid(auctionId);
      
        System.out.println("✅ Thanh toán thành công! Trạng thái: PAID");
