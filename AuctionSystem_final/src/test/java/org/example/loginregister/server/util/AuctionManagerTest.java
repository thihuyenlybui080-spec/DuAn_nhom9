...
class AuctionManagerTest {
    ...
    void testStartAuction() {
        ...
        auctionManager.startAuction(auctionId, dummyItem, seller1,3600);
    ...
    void testStartDuplicateAuction() {
        ...
        auctionManager.startAuction(auctionId, dummyItem, seller1,60);
    ...
    void testPlaceBidSuccess() {
        ...
        auctionManager.startAuction(auctionId, dummyItem, seller1,3600); // 1 giờ
    ...
    void testAntiSnipingTriggers() {
        ...
        auctionManager.startAuction(auctionId, dummyItem, seller1,10);
    ...
    void testAuctionAutoEndAndSaveHistory() throws InterruptedException {
        ...
        auctionManager.startAuction(auctionId, dummyItem, seller1,1);
    ...
    void testShutdown() {
        ...
        assertThrows(java.util.concurrent.RejectedExecutionException.class, () -> {
            auctionManager.startAuction("TEST_SHUTDOWN", dummyItem, seller1,10);
