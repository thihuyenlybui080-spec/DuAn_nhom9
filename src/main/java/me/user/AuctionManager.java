...
public class AuctionManager {
    ...
    /**
     * Hàm này CHỈ DÙNG CHO MỤC ĐÍCH UNIT TEST.
     * Dọn dẹp ThreadPool và reset lại instance Singleton.
     */
    protected void resetForTesting() {
        ...
        instance = null; // Phá vỡ Singleton để lần gọi getInstance() sau sẽ tạo mới
    }
}