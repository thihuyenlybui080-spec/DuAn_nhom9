...
class OtherTest {
  ...
  void testConstructorWithId() {
    ...
    Other otherWithId =
        new Other(605, "Vintage Stamp", 602, "Rare 19th-century stamp", 200.0, startTime, endTime);

    assertEquals(
        605, otherWithId.getId(), "The ID should match the value passed in the constructor");
