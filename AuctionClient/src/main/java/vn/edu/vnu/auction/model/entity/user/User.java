 ...
 * <p>
 * Lớp này cung cấp các thuộc tính và phương thức chung cho tất cả các loại người dùng, bao gồm
 * thông tin đăng nhập, trạng thái tài khoản, và các phương thức xác thực.
 * </p>
 */
public abstract class User extends Entity {
  ...
  /**
   * Phương thức callback được gọi khi trạng thái người dùng thay đổi. Có thể được ghi đè bởi các
   * lớp con để xử lý logic cụ thể.
   *
   ...
   * @throws AuthenticationException nếu tên đăng nhập hoặc mật khẩu không đúng, hoặc nếu tài khoản
   *                                 bị khóa
   */
   ...
   */
  public UserStatusRecord getStatusRecord() {
    return statusRecord;
  }
  ...
  public boolean isActive() {
    return statusRecord.getStatus().isActive();
  }
  ...
  /**
   * Lấy vai trò của người dùng. Phương thức trừu tượng phải được triển khai bởi các lớp con.
   *
