...
class NotificationMessageTest {
    ...
    void testConstructorAndGetters() {
        ...
        assertEquals(expectedAuctionId, message.getAuctionId(), "Mã phiên đấu giá (Auction ID) phải khớp chính xác");
    ...
    void testToString() {
        ...
        NotificationMessage message = new NotificationMessage(NotificationMessage.TYPE_AUCTION_ENDED, 99, null);
        ...
        // Step 3: Kiểm tra
        assertEquals(expectedString, message.toString(), "Hàm toString() phải in ra đúng format đã định dạng");
    }
}