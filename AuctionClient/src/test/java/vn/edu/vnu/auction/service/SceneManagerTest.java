...
class SceneManagerTest {
  ...
  /**
   * Test nhánh: Load FXML không tồn tại. Vì FXMLLoader sẽ ném IllegalStateException khi đường dẫn
   * null (file không tồn tại), và SceneManager không catch lỗi này, ta cần assertThrows để test
   * pass.
   */
  @Test
