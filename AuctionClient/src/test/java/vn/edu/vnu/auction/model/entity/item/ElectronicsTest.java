...
class ElectronicsTest {
    ...
    void setUp() {
        ...
        electronics = new Electronics("Gaming Laptop", 301, "High performance gaming laptop", 1500.0, startTime, endTime);
    }

    @Test
    void testGetCategory() {
        // Verify that the overridden method returns exactly "Electronics"
        assertEquals("Electronics", electronics.getCategory(), "The category of the object must be 'Electronics'");
    }
    ...
    void testConstructorWithId() {
        ...
        Electronics electronicsWithId = new Electronics(404, "Smartphone", 302, "Latest flagship smartphone", 800.0, startTime, endTime);

        assertEquals(404, electronicsWithId.getId(), "The ID should match the value passed in the constructor");
