...
class ElectronicsFactoryTest {
    ...
    void testCreateItem() {
        ...
        assertTrue(createdItem instanceof Electronics, "The created item must be an instance of the Electronics class");
        ...
        assertEquals("Electronics", createdItem.getCategory(), "The category of the created item must be 'Electronics'");
    }
}