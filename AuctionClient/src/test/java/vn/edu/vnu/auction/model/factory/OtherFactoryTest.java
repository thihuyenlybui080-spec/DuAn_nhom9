...
class OtherFactoryTest {
    ...
    void testCreateItem() {
        ...
        assertTrue(createdItem instanceof Other, "The created item must be an instance of the Other class");
        ...
        assertEquals("Other", createdItem.getCategory(), "The category of the created item must be 'Other'");
    }
}