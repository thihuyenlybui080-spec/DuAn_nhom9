...
class ArtTest {
  ...
  void setUp() {
    ...
    art = new Art("Mona Lisa Replica", 201, "High quality oil painting", 5000.0, startTime,
        endTime);
  }
  ...
  void testConstructorWithId() {
    ...
    Art artWithId = new Art(88, "Starry Night Print", 202, "Beautiful canvas print", 300.0,
        startTime, endTime);
