...
class AuctionManagerTest {
    ...
    void testStartDuplicateAuction() {
        ...
        // Mình sẽ lấy thời gian còn lại, nếu nó <= 60 thì chứng tỏ phiên sau không đè lên phiên trước
    ...
    void testAntiSnipingTriggers() {
        ...
        // Code của bạn cộng thêm 60s. Nên newRemaining phải loanh quanh mức 70s.
