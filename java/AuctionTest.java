...
class AuctionTest {
    ...
    void setUp() {
        ...
        // Lưu ý: Bạn cần điều chỉnh lại constructor của Item và Bidder
        // cho khớp với code thực tế trong project của nhóm nhé.
        // Ở đây mình giả sử Item là abstract nên dùng một class con giả định (ví dụ Electronics)
        item = new Electronics("SP01", "Laptop Dell", "Levono intel",1000, 1000, start, end);

        // Khởi tạo phiên đấu giá kéo dài 3600 giây (1 giờ)
        auction = new Auction("A01", item, 3600);
